...
import client.request.GetRequest;
import client.request.PostRequest;
import client.request.PutRequest;
import client.request.DeleteRequest;
import client.request.PatchRequest;
...
public class ApiInvoker {
  ...
  */
  ...
  public static void initializeInstance(Cache cache, Network network, int threadPoolSize, ResponseDelivery delivery, int connectionTimeout) {
    ...
    INSTANCE.authentications.put("tokenAuth", new ApiKeyAuth("header", "Authorization"));
